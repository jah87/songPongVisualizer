    ...
    render() {
        ...
        return (
            <div className="fixed-bottom navbar-inverse bg-inverse">
                ...
                <div className="text-center flex-box player-box">
                
                    <img src="/icons/icon_arrow_left.svg" onClick={()=>{this.clickPrev()}} className="arrowMargins" alt="Previous Button" />
                    ...
                    <img src="/icons/icon_arrow_right.svg" onClick={()=>{this.clickNext()}} className="arrowMargins" alt="Next Button" />
